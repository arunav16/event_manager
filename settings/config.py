...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='7423c8fd0681ad', description="Username for SMTP server")
    smtp_password: str = Field(default='c61127688bee60', description="Password for SMTP server")
